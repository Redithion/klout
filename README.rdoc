...
<i>Note: this gem only supports {version 2}[http://klout.com/s/developers/v2] of the Klout API</i>.
<i>Note 2: I only modified this gem to use Mechanize instead of HTTParty as the last one had issues with the encoding of some Json responses.</i>
